/**
 * SMOOTH N SHINE AESTHETICS TREATMENTS
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (bookingForm) {
    bookingForm.addEventListener("submit", (e) => {
      ...
      if (alertBox) {
        ...
        alertBox.innerHTML =
          '<i class="bi bi-check-circle-fill me-2"></i> Thank you! Your TREATMENTS appointment has been booked. Our expert coordinator will call you shortly to confirm Expert availability.';
        bookingForm.reset();
      }
    });
  }
    ...
    contactForm.addEventListener("submit", (e) => {
      ...
      if (contactAlert) {
        ...
        contactAlert.innerHTML =
          '<i class="bi bi-check-circle-fill me-2"></i> Your message has been sent successfully! Our team will get back to you within 2 hours.';
        contactForm.reset();
      }
    });
  }
  ...
  if (enquiryForm) {
    enquiryForm.addEventListener("submit", (e) => {
      ...
      if (enquiryAlert) {
        ...
        enquiryAlert.innerHTML =
          '<i class="bi bi-check-circle-fill me-2"></i> Thank you! Your enquiry has been received. Our team will contact you shortly.';
        enquiryForm.reset();
      }
    });
  }
  ...
  if (offcanvasEl) {
    const offcanvasLinks = offcanvasEl.querySelectorAll(
...
//Manage paragraph
document.querySelectorAll(".Expert-description").forEach(function (paragraph) {
